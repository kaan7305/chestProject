...
namespace Chess {
bool Knight::legal_move_shape(const Position &start,
  ...
  // Also we have to chec if the move is legit by checking if it is white or
  // black
...
int Knight::point_value() const { return 3; }
}